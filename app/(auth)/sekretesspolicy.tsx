...
import { StyleSheet, View, TouchableOpacity, ViewStyle, TextStyle, Linking, ScrollView } from 'react-native';
    ...
    return (
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            <View style={styles.container}>
                ...
                <FooterWrapper contentContainerStyle={styles.content} scrollEnabled={true}>
                    <DesktopViewWrapper>
